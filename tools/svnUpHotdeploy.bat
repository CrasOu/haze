...
rem This is useful when you keep a link with Apache Haze repository and have your own repository for hot-deploy

setlocal EnableDelayedExpansion

rem SVN path of the hot-deploy folder, here is just a suggestion, to be adapted to you real repository
set SVN_PATH=.../implementation/trunk/haze/hot-deploy/

...
import org.haze.base.concurrent.ExecutionPool;
import org.haze.base.container.ClassLoaderContainer;
...
import org.haze.base.container.ContainerConfig.Container.Property;
...
//import org.haze.entity.Delegator;
//import org.haze.entity.DelegatorFactory;
...
public class CatalinaContainer implements Container {
    ...
    public static final String CATALINA_HOSTS_HOME = System.getProperty("haze.home") + "/framework/catalina/hosts";
    public static final String J2EE_SERVER = "HAZE Container 3.1";
    public static final String J2EE_APP = "HAZE";
    ...
    public void init(String[] args, String configFile) throws ContainerException {
        ...
        // set catalina_home
        System.setProperty(Globals.CATALINA_HOME_PROP, System.getProperty("haze.home") + "/" + this.catalinaRuntimeHome);
        ...
        tomcat = new Tomcat();
        tomcat.setBaseDir(System.getProperty("haze.home"));
        if (useNaming) {
            tomcat.enableNaming();
        }
    ...
    protected Engine createEngine(ContainerConfig.Container.Property engineConfig) throws ContainerException {
        ...
        if (logDir != null) {
            ...
            if (!logDir.startsWith("/")) {
                logDir = System.getProperty("haze.home") + "/" + logDir;
            }

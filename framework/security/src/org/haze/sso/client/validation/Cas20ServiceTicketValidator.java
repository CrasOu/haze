 ...
 * under the License.
 */
package org.haze.sso.client.validation;
...
import org.haze.sso.client.Assertion;
import org.haze.sso.client.AssertionImpl;
import org.haze.sso.client.authentication.AttributePrincipal;
import org.haze.sso.client.authentication.AttributePrincipalImpl;
import org.haze.sso.client.proxy.Cas20ProxyRetriever;
import org.haze.sso.client.proxy.ProxyGrantingTicketStorage;
import org.haze.sso.client.proxy.ProxyRetriever;
...
public class Cas20ServiceTicketValidator extends AbstractCasProtocolUrlBasedTicketValidator {
    ...
    protected final Assertion parseResponseFromServer(final String response) throws TicketValidationException {
        ...
        if (!result.getSuccess()) {
            throw new TicketValidationException(result.getMessage());
        }

        
        final String principal = result.getString("user");
       // final String proxyGrantingTicketIou = XmlUtils.getTextForElement(response, "proxyGrantingTicket");
        final String proxyGrantingTicketIou = result.getString("ticket");
     ...
     */
    protected Map<String, Object> extractCustomAttributes(final String json) {
    	ResponseResult result = JSONUtils.fromJson(json,ResponseResult.class);
    	return (Map<String,Object>)result.get("attributes");
    }

 ...
 * under the License.
 *******************************************************************************/
package org.haze.base.location;
...
public class FlexibleLocation {
    ...
    protected static String hazeHomeResolverName = HazeHomeLocationResolver.class.getName();
    ...
    static {
        ...
        defaultResolvers.put("hazehome", hazeHomeResolverName);
     ...
     * Supports haze specific location types like hazehome and component

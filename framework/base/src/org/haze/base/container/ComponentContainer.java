 ...
 * under the License.
 *******************************************************************************/
package org.haze.base.container;
...
import org.haze.base.component.AlreadyLoadedException;
import org.haze.base.component.ComponentConfig;
import org.haze.base.component.ComponentException;
import org.haze.base.component.ComponentLoaderConfig;
import org.haze.base.start.Classpath;
import org.haze.base.util.Debug;
import org.haze.base.util.FileUtil;
import org.haze.base.util.UtilValidate;

/**
 * ComponentContainer - StartupContainer implementation for Components
 * <p/>
 * Example haze-container.xml configuration:
 * <pre>
 *   <container name="component-container" class="org.haze.base.component.ComponentContainer"/>
 * </pre>
 */
public class ComponentContainer implements Container {
    ...
    static {
    	...
    	System.out.println("ComponentContainer class:" + System.getProperty("java.class.path"));
    	System.out.println("ComponentContainer library :" + System.getProperty("java.library.path"));
    }
    ...
    /**
     * @see org.haze.base.container.Container#init(java.lang.String[], java.lang.String)
     */
    public void init(String[] args, String configFile) throws ContainerException {
        ...
        if (cc.getProperty("haze.instrumenterClassName") != null) {
            instrumenterClassName = cc.getProperty("haze.instrumenterClassName").value;
        } else {
            instrumenterClassName = null;
        }
        if (cc.getProperty("haze.instrumenterFile") != null) {
            instrumenterFile = cc.getProperty("haze.instrumenterFile").value;
        } else {
    ...
    /**
     * @see org.haze.base.container.Container#start()
     */
    ...
    public synchronized void loadComponents(String loaderConfig, boolean updateClasspath, String instrumenterClassName, String instrumenterFile) throws AlreadyLoadedException, ComponentException {
        ...
        String parentPath;
        try {
            parentPath = FileUtil.getFile(System.getProperty("haze.home")).getCanonicalFile().toString().replaceAll("\\\\", "/");
                ...
                for (String sub: fileNames) {
                    try {
                        ...
                        if (componentPath.isDirectory() && !sub.equals("CVS") && !sub.equals(".svn")) {
                            ...
                            File configFile = FileUtil.getFile(componentLocation + "/haze-component.xml");
    ...
    /**
     * @see org.haze.base.container.Container#stop()
     */

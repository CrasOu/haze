...
import org.haze.base.start.Config;
import org.haze.base.start.StartupException;
import org.haze.base.start.StartupLoader;
 ...
 * 
 * <p>Normally, instances of this class are created by haze startup code, and
...
public class ContainerLoader implements StartupLoader {
    ...
    /**
     * @see org.haze.base.start.StartupLoader#load(Config, String[])
     */
    public synchronized void load(Config config, String args[]) throws StartupException {
        ...
        for (ContainerConfig.Container containerCfg : containers) {
            ...
            // This is only used in case of haze running in Geronimo or WASCE. It allows to use the RMIDispatcher
    ...
    /**
     * @see org.haze.base.start.StartupLoader#start()
     */
    ...
    /**
     * @see org.haze.base.start.StartupLoader#unload()
     */

 ...
 * under the License.
 *******************************************************************************/
package org.haze.base.json.test;
...
import org.haze.base.json.JSON;
import org.haze.base.json.JSONConstants;
import org.haze.base.json.JSONWriter;
import org.haze.base.json.ParseException;
import org.haze.base.json.Token;
import org.haze.base.json.TokenMgrError;
import org.haze.base.lang.SourceMonitored;
import org.haze.base.test.GenericTestCaseBase;
import org.haze.base.util.IndentingWriter;
...
public class JSONTests extends GenericTestCaseBase {
    ...
    public void testResolve() throws Exception {
        assertResolveJSON("url", new URL("http://haze.hs.org"), "resolve(\"java.net.URL:http:\\/\\/haze.apache.org\")");
        IOException caught = null;
        try {
            getJSON(new URL("http://haze.hs.org"), false);
        } catch (IOException e) {
            caught = e;
        } finally {

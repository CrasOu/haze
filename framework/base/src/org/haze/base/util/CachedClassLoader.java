...
public class CachedClassLoader extends URLClassLoader {
    ...
    static {
        ...
        // setup Haze classes
        registerClass(org.haze.base.util.TimeDuration.class);
    ...
    public String toString() {
        return "org.haze.base.util.CachedClassLoader(" + contextName + ") / " + getParent().toString();
    }
    ...
    protected boolean isGlobalPath(String name) {
        ...
        if (name.startsWith("org.haze.")) return true;
        return false;
    }
}

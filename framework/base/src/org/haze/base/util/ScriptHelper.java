...
/**
 * A script helper object. The Haze scripting framework will include an instance of this class in the script's bindings.
 * <p>The scripting language will determine how the helper is used. Most languages will access it as a variable:<br />
 * <code>partyValue = haze.findOne("Party");</code><br />

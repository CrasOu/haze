 ...
 * under the License.
 *******************************************************************************/
package org.haze.base.util.template;
...
import org.haze.base.util.StringUtil;
import org.haze.base.util.UtilGenerics;
import org.haze.base.util.UtilMisc;
import org.haze.base.util.UtilProperties;
import org.haze.base.util.UtilValidate;
import org.haze.base.util.cache.UtilCache;
...
public class FreeMarkerWorker {
    ...
    protected static BeansWrapper defaultHazeWrapper = BeansWrapper.getDefaultInstance();
    protected static Configuration defaultHazeConfig = makeConfiguration(defaultHazeWrapper);
    ...
    public static Configuration makeConfiguration(BeansWrapper wrapper) {
        ...
        newConfig.setTemplateExceptionHandler(new FreeMarkerWorker.HazeTemplateExceptionHandler());
        try {
        ...
        if (template == null) {
            synchronized (cachedTemplates) {
                ...
                if (template == null) {
                    ...
                    template = new Template(templateLocation, templateReader, defaultHazeConfig);
    ...
    /**
     * Returns a <code>Configuration</code> instance initialized to Haze defaults. Client code should
     * call this method instead of creating its own <code>Configuration</code> instance. The instance
     * returned by this method includes the <code>component://</code> resolver and the Haze custom
     * transformations.
     * 
     * @return A <code>Configuration</code> instance.
     */
    public static Configuration getDefaultHazeConfig() {
        return defaultHazeConfig;
    }
    ...
    public static Template getTemplate(String templateLocation) throws TemplateException, IOException {
        return getTemplate(templateLocation, cachedTemplates, defaultHazeConfig);
    }
    ...
    */
    ...
    /**
     * Haze Template Source. This class is used by FlexibleTemplateLoader.
     */
    ...
    /**
     * Haze Template Loader. This template loader uses the FlexibleLocation
    ...
    /**
     * Haze specific TemplateExceptionHandler.  Sanitizes any error messages present in
     * the stack trace prior to printing to the output writer.
     */
    static class HazeTemplateExceptionHandler implements TemplateExceptionHandler {

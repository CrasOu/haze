 ...
 *
 */
public class HazeBshBsfEngine extends BSFEngineImpl {

    public static final String module = HazeBshBsfEngine.class.getName();
    ...
    public Object eval(String source, int lineNo, int columnNo, Object expr) throws BSFException {
        ...
        try {
            ...
            if (UtilValidate.isNotEmpty(source)) {
                ...
                if (script == null) {
                    synchronized (HazeBshBsfEngine.class) {
                        script = parsedScripts.get(source);
                        if (script == null) {

 ...
 * under the License.
 *******************************************************************************/
package org.haze.base.util.string;
...
import org.haze.base.util.collections.LocalizedMap;
...
public class UelUtil {
    ...
    /** Custom <code>ListELResolver</code> used to handle Haze
    ...
    /** Prepares an expression for evaluation by UEL.<p>The Haze syntax is
